          ...
          <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
            {related.map((p) => (
              <Link
                key={p.slug}
                href={`/blog/${p.slug}`}
                className="group flex items-center justify-between rounded-xl border border-[var(--line)] bg-[var(--surface)] px-5 py-4 transition-all duration-300 hover:border-[var(--primary)]/30 hover:shadow-[var(--shadow-md)]"
              >
